...
do
	...
	if [ "$JOB_STATUS" == "FINISHED" ]; then
		./slackpost.sh https://hooks.slack.com/services/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 "#test_rx" zeppelin_chronos "Zeppelin Note $2 (Name=$3) has been successully completed"
		break
	elif ([ "$JOB_STATUS" == "ABORT" ] || [ "$JOB_STATUS" = "ERROR" ]); then
		./slackpost.sh https://hooks.slack.com/services/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 "#test_rx" zeppelin_chronos "Zeppelin Note $2 (Name=$3) has been completed with status $JOB_STATUS"
                break
	fi
